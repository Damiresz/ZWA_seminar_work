      ...
      <nav class="nav">
        ...
        <seaech>
          <form action="#!" class="nav-search">
            <label class="nav-search__label" for="search">search</label>
            <div class="nav-search__item">
              <input type="search" id="search">
              <button type="submit">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M11 19C15.4183 19 19 15.4183 19 11C19 6.58172 15.4183 3 11 3C6.58172 3 3 6.58172 3 11C3 15.4183 6.58172 19 11 19Z" stroke="#1D084B" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                  <path d="M21 21L16.65 16.65" stroke="#1D084B" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                  </svg>
              </button>
            </div>
          </form>
        ...
        <div class="nav-buttons">
          <a href="profil_basket.html" class="nav-search__link">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <a href="#!" class="nav-search__link">Logout</a>
          <a href="registration.html" class="nav-search__link">Registration</a>
          <a href="login.html" class="nav-search__link">Log in</a>
        </div>
      </nav>
    </div>
  </div>
      ...
      <div class="main-page">
        ...
        <aside class="aside">
          ...
          <ul class="aside__items">
            <li><a href="#!" class="aside__link">New</a></li>
            <li><a href="#!" class="aside__link">Gel-laks</a></li>
            <li><a href="#!" class="aside__link">Base</a></li>
            <li><a href="#!" class="aside__link">Tops</a></li>
            <li><a href="#!" class="aside__link">Gels</a></li>
          </ul>
        </aside>
          <!-- Main_content -->
        <div class="main-content">
          ...
          <div class="products">
            ...
            <div class="product-card">
              <img src="/image/products/1.webp" alt="cadr-photo" class="product-card__img">
              <div class="product-card__items">
                <h2 class="product-card__title">Gel-Lak №11</h2>
                <p class="product-card__price">239 Kč</p>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit.Fugiat possimus impedit distinctio reprehenderit laboriosam cupiditate assumenda!</p>
              </div>
              <div class="product-card__to-basket">
                <button class="product-card__button">+add to busket</button>
              </div>
            </div>

            <div class="product-card">
              <img src="/image/products/2.webp" alt="cadr-photo" class="product-card__img">
              <div class="product-card__items">
                <h2 class="product-card__title">Gel-Lak №12</h2>
                <p class="product-card__price">239 Kč</p>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit.Fugiat possimus impedit distinctio reprehenderit laboriosam cupiditate assumenda!</p>
              </div>
              <div class="product-card__to-basket">
            ...
            <div class="product-card">
              <img src="/image/products/3.webp" alt="cadr-photo" class="product-card__img">
              <div class="product-card__items">
                <h2 class="product-card__title">Gel-Lak №28</h2>
                <p class="product-card__price">239 Kč</p>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit.Fugiat possimus impedit distinctio reprehenderit laboriosam cupiditate assumenda!</p>
              </div>
              <div class="product-card__to-basket">
            ...
            <div class="product-card">
              <img src="/image/products/4.webp" alt="cadr-photo" class="product-card__img">
              <div class="product-card__items">
                <h2 class="product-card__title">Gel-Lak №41</h2>
                <p class="product-card__price">239 Kč</p>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit.Fugiat possimus impedit distinctio reprehenderit laboriosam cupiditate assumenda!</p>
              </div>
              <div class="product-card__to-basket">
            ...
            <div class="product-card">
              <img src="/image/products/5.webp" alt="cadr-photo" class="product-card__img">
              <div class="product-card__items">
                <h2 class="product-card__title">Gel-Lak №17</h2>
                <p class="product-card__price">239 Kč</p>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit.Fugiat possimus impedit distinctio reprehenderit laboriosam cupiditate assumenda!</p>
              </div>
              <div class="product-card__to-basket">
            ...
            <div class="product-card">
              <img src="/image/products/6.webp" alt="cadr-photo" class="product-card__img">
              <div class="product-card__items">
                <h2 class="product-card__title">Gel-Lak №46</h2>
                <p class="product-card__price">239 Kč</p>
                <p>Lorem ipsum sit amet consectetur adipisicing elit.Fugiat possimus impedit distinctio reprehenderit laboriosam cupiditate assumenda!</p>
              </div>
              <div class="product-card__to-basket">
                <button class="product-card__button">+add to busket</button>
              </div>
