      ...
      <div class="container">
        <nav class="nav">
          ...
          <div class="nav-buttons">
            ...
            <a href="#!" class="nav-search__link">Registration</a>
            <a href="#!" class="nav-search__link">Login</a>
          </div>
        </nav>
      </div>
    </div>
          ...
          <div class="profil">
            ...
            >
              <div class="add_products_items">
                ...
                <div class="profile__item  add__item">
                  <label for="add_file">Photo</label>
                  <input type="file" name="add_file" id="add_file" />
                  <spam class="error_local"></spam>
                </div>
                <div class="profile__item  add__item">
                  <label for="discription">Discription</label>
                  <textarea id="discription" name="discription" rows="10" cols="" required></textarea>
                  <spam class="error_local"></spam>
                </div>
                <div class="profile__item  add__item">
